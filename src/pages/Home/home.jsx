...
export default function Home() {
  return (
    <div>
      <div className="container flex flex-col w-screen h-screen m-auto">
        <Navbar></Navbar>
        <div className="text-[200px] w-full relative h-full">
